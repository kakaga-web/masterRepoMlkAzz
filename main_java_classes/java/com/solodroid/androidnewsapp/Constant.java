...
public class Constant implements Serializable{
	...
	public static final String SERVER_IMAGE_CATEGORY="http://stu4me.com/news/news/upload/category/";

	//this is the path of uploaded image of newslist thumb
	public static final String SERVER_IMAGE_NEWSLIST_THUMBS="http://stu4me.com/news/news/upload/thumbs/";

	//this is the path of uploaded image of news list
	public static final String SERVER_IMAGE_NEWSLISTDETAILS="http://stu4me.com/news/news/upload/";

	//this url is used to get recent 20 news in 1st tab.
	public static final String LATEST_URL = "http://stu4me.com/news/news/api.php?latest_news=50";

	//this url gives list of category in 2nd tab
	public static final String CATEGORY_URL = "http://stu4me.com/news/news/api.php";

	//this url gives item of specific category.
	public static final String CATEGORY_ITEM_URL = "http://stu4me.com/news/news/api.php?cat_id=";

	//this url gives your company details
	public static final String COMPANY_DETAILS_URL = "http://stu4me.com/news/news/api.php?apps_details";
